...
export class SchedulerTools {
    ...
    public get removeTaskTool(): Tool {
        return {
            ...
            execute: async (args: any) => {
                if (!this.tasks.has(args.id)) throw new Error(`Task ${args.id} not found`);
